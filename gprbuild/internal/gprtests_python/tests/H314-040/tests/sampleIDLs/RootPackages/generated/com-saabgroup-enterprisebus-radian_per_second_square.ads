...
package com.saabgroup.enterprisebus.RADIAN_PER_SECOND_SQUARE is
   ...
   pragma Import (C, Get_TypeCode, "com_saabgroup_enterprisebus_RADIAN_PER_SECOND_SQUARE_get_typecode");
