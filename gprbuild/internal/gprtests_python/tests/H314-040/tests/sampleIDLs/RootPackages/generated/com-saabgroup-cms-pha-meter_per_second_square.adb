...
with RTI;
package body com.saabgroup.cms.pha.METER_PER_SECOND_SQUARE is
   use type RTI.Bool;
     ...
     (This              : in out METER_PER_SECOND_SQUARE) is
      function Internal
        (This : not null access METER_PER_SECOND_SQUARE)
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_cms_pha_METER_PER_SECOND_SQUARE_initialize_ex");
   begin
     ...
     (This            : in out METER_PER_SECOND_SQUARE) is
      function Internal
        (This : access METER_PER_SECOND_SQUARE)
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_cms_pha_METER_PER_SECOND_SQUARE_finalize_ex");
   begin
      if not Internal (This'Unrestricted_Access) then
     ...
     (Dst : in out METER_PER_SECOND_SQUARE;
      ...
      function Internal
        (Dst : not null access METER_PER_SECOND_SQUARE;
         ...
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_cms_pha_METER_PER_SECOND_SQUARE_copy");
   begin
...
end com.saabgroup.cms.pha.METER_PER_SECOND_SQUARE;
