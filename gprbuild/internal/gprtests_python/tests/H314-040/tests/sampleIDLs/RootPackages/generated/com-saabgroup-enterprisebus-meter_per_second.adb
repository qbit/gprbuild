...
with RTI;
package body com.saabgroup.enterprisebus.METER_PER_SECOND is
   use type RTI.Bool;
     ...
     (This              : in out METER_PER_SECOND) is
      function Internal
        (This : not null access METER_PER_SECOND)
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_enterprisebus_METER_PER_SECOND_initialize_ex");
   begin
     ...
     (This            : in out METER_PER_SECOND) is
      function Internal
        (This : access METER_PER_SECOND)
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_enterprisebus_METER_PER_SECOND_finalize_ex");
   begin
      if not Internal (This'Unrestricted_Access) then
     ...
     (Dst : in out METER_PER_SECOND;
      ...
      function Internal
        (Dst : not null access METER_PER_SECOND;
         ...
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_enterprisebus_METER_PER_SECOND_copy");
   begin
...
end com.saabgroup.enterprisebus.METER_PER_SECOND;
