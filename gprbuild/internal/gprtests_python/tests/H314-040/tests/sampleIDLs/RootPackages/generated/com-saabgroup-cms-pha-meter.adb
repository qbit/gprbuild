...
with RTI;
package body com.saabgroup.cms.pha.METER is
   use type RTI.Bool;
     ...
     (This              : in out METER) is
      function Internal
        (This : not null access METER)
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_cms_pha_METER_initialize_ex");
   begin
   ...
   procedure Finalize
     (This            : in out METER) is
      function Internal
        (This : access METER)
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_cms_pha_METER_finalize_ex");
   begin
      if not Internal (This'Unrestricted_Access) then
     ...
     (Dst : in out METER;
      ...
      function Internal
        (Dst : not null access METER;
         ...
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_cms_pha_METER_copy");
   begin
