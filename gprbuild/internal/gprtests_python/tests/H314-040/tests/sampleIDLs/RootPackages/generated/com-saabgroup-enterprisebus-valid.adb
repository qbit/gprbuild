...
with RTI;
package body com.saabgroup.enterprisebus.VALID is
   use type RTI.Bool;
     ...
     (This              : in out VALID) is
      function Internal
        (This : not null access VALID)
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_enterprisebus_VALID_initialize_ex");
   begin
   ...
   procedure Finalize
     (This            : in out VALID) is
      function Internal
        (This : access VALID)
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_enterprisebus_VALID_finalize_ex");
   begin
      if not Internal (This'Unrestricted_Access) then
     ...
     (Dst : in out VALID;
      ...
      function Internal
        (Dst : not null access VALID;
         ...
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_enterprisebus_VALID_copy");
   begin
