...
with RTI;
package body com.saabgroup.enterprisebus.RADIAN is
   use type RTI.Bool;
     ...
     (This              : in out RADIAN) is
      function Internal
        (This : not null access RADIAN)
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_enterprisebus_RADIAN_initialize_ex");
   begin
   ...
   procedure Finalize
     (This            : in out RADIAN) is
      function Internal
        (This : access RADIAN)
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_enterprisebus_RADIAN_finalize_ex");
   begin
      if not Internal (This'Unrestricted_Access) then
     ...
     (Dst : in out RADIAN;
      ...
      function Internal
        (Dst : not null access RADIAN;
         ...
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_enterprisebus_RADIAN_copy");
   begin
