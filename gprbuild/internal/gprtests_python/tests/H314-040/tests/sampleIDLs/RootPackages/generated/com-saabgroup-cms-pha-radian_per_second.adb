...
with RTI;
package body com.saabgroup.cms.pha.RADIAN_PER_SECOND is
   use type RTI.Bool;
     ...
     (This              : in out RADIAN_PER_SECOND) is
      function Internal
        (This : not null access RADIAN_PER_SECOND)
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_cms_pha_RADIAN_PER_SECOND_initialize_ex");
   begin
     ...
     (This            : in out RADIAN_PER_SECOND) is
      function Internal
        (This : access RADIAN_PER_SECOND)
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_cms_pha_RADIAN_PER_SECOND_finalize_ex");
   begin
      if not Internal (This'Unrestricted_Access) then
     ...
     (Dst : in out RADIAN_PER_SECOND;
      ...
      function Internal
        (Dst : not null access RADIAN_PER_SECOND;
         ...
         return RTI.Bool;
      pragma Import (C, Internal, "com_saabgroup_cms_pha_RADIAN_PER_SECOND_copy");
   begin
