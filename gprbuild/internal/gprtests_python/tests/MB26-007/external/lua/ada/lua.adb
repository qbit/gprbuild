...
package body Lua is
   ...
   package C_Bindings is
      ...
      type Lua_Cmp_Op is ( Lua_Op_Eq, Lua_Op_Lt, Lua_Op_Le );
      for Lua_Cmp_Op use
         ( Lua_Op_Eq => 0,
           Lua_Op_Lt => 1,
           Lua_Op_Le => 2 );

      function lua_version( State : State_t ) return access Number_t;
      ...
      -- we must have a separate function since
      -- * the underlying C code defines the registry index as a series of #define
      -- * which shouldn't be a problem, until we realize that the #define is platform dependent => we need a specific function
      function luext_registry_index return Integer_t;
      pragma Import(C, luext_registry_index, "luext_registry_index");
      ...
      procedure lua_settop (State : State_t; Index : Integer_t);
      pragma Import (C, lua_settop, "lua_settop");

      function lua_checkstack (State : State_t; Extra : Integer_t) return Integer_t;
      pragma Import (C, lua_checkstack, "lua_checkstack");

      procedure lua_pushvalue (State : State_t; Index : Integer_t);
      pragma Import (C, lua_pushvalue, "lua_pushvalue");

      procedure lua_remove (State : State_t; Index : Integer_t);
      pragma Import (C, lua_remove, "lua_remove");

      procedure lua_insert (State : State_t; Index : Integer_t);
      pragma Import (C, lua_insert, "lua_insert");

      procedure lua_replace (State : State_t; Index : Integer_t);
      ...
      function lua_typename (State : State_t; Index : Integer_t) return ICS.chars_ptr;
      pragma Import (C, lua_typename, "lua_typename");

      function lua_type (State : State_t; Index : Integer_t) return Integer_t;
      pragma Import (C, lua_type, "lua_type");

      function lua_isnumber (State : State_t; Index : Integer_t) return Integer_t;
      pragma Import (C, lua_isnumber, "lua_isnumber");

      function lua_isstring (State : State_t; Index : Integer_t) return Integer_t;
      pragma Import (C, lua_isstring, "lua_isstring");

      function lua_iscfunction (State : State_t; Index : Integer_t) return Integer_t;
      pragma Import (C, lua_iscfunction, "lua_iscfunction");

      function lua_isuserdata (State : State_t; Index : Integer_t) return Integer_t;
      ...
      function lua_toboolean (State : State_t; Index : Integer_t) return Integer_t;
      pragma Import (C, lua_toboolean, "lua_toboolean");

      function lua_tonumberx (State : State_t;
                              Index : Integer_t;
                              Is_Number : access Integer_t
                              ) return Number_t;
      pragma Import (C, lua_tonumberx, "lua_tonumberx");

      function lua_tointegerx (State : State_t;
                               Index : Integer_t;
                               Is_Number : access Integer_t
                               ) return Integer_t;
      pragma Import (C, lua_tointegerx, "lua_tointegerx");

      function lua_tothread (State : State_t; Index : Integer_t) return State_t;
      pragma Import (C, lua_tothread, "lua_tothread");

      function luext_tostring (State : State_t; Index : Integer_t) return ICS.chars_ptr;
      pragma Import (C, luext_tostring, "luext_tostring");

      function lua_rawlen (State : State_t; Index : Integer_t) return Integer_t;
      pragma Import (C, lua_rawlen, "lua_rawlen");

      function lua_len (State : State_t; Index : Integer_t) return Integer_t;
      pragma Import (C, lua_len, "lua_len");

      function lua_tocfunction (State : State_t; Index : Integer_t) return User_Function_t;
      ...
      procedure lua_pushboolean (State : State_t; B : Integer_t);
      pragma Import (C, lua_pushboolean, "lua_pushboolean");

      procedure lua_pushnumber (State : State_t; N : Number_t);
      pragma Import (C, lua_pushnumber, "lua_pushnumber");

      procedure lua_pushinteger (State : State_t; I : Integer_t);
      pragma Import (C, lua_pushinteger, "lua_pushinteger");

      procedure lua_pushstring (State : State_t; Str : ICS.chars_ptr);
      pragma Import (C, lua_pushstring, "lua_pushstring");

      procedure lua_pushlstring (State : State_t; Address : System.Address; Size : IC.size_t);
      ...
      procedure lua_concat (State : State_t; num : Natural_t);
      pragma Import (C, lua_concat, "lua_concat");

      function lua_next (State : State_t; Index : Integer_t) return Integer_t;
      ...
      function lua_getmetatable (State : State_t; Index : Integer_t) return Integer_t;
      pragma Import (C, lua_getmetatable, "lua_getmetatable");

      function lua_setmetatable (State : State_t; Index : Integer_t) return Integer_t;
      ...
      procedure lua_callk (State : State_t;
      ...
      procedure lua_createtable (State : State_t; num_arr : Integer_t; num_rec : Integer_t);
      pragma Import (C, lua_createtable, "lua_createtable");

      procedure lua_settable (State : State_t; Index : Integer_t);
      pragma Import (C, lua_settable, "lua_settable");

      procedure lua_gettable (State : State_t; Index : Integer_t);
      pragma Import (C, lua_gettable, "lua_gettable");

      procedure lua_rawget (State : State_t; Index : Integer_t);
      pragma Import (C, lua_rawget, "lua_rawget");

      procedure lua_rawset (State : State_t; Index : Integer_t);
      pragma Import (C, lua_rawset, "lua_rawset");

      procedure lua_rawgeti (State : State_t; Index : Integer_t; Element : Integer_t);
      pragma Import (C, lua_rawgeti, "lua_rawgeti");

      procedure lua_rawseti (State : State_t; Index : Integer_t; Element : Integer_t);
      ...
      function lua_atpanic (State : State_t; Func : User_Function_t) return User_Function_t;
      procedure lua_atpanic (State : State_t; Func : User_Function_t);
      ...
      procedure lua_setfield (State : State_t; Index : Integer_t; Key : ICS.chars_ptr);
      pragma Import (C, lua_setfield, "lua_setfield");

      procedure lua_setglobal( State : State_t; Var : ICS.chars_ptr );
      ...
      procedure lua_getfield (State : State_t; Index : Integer_t; Key : ICS.chars_ptr);
      pragma Import (C, lua_getfield, "lua_getfield" );

      procedure lua_getglobal( State : State_t; Key : ICS.Chars_Ptr);
      ...
      function lua_resume (State : State_t; Narg : Integer_t) return Integer_t;
   ...
   function Load_String (State : State_t; Buffer : String;
                         Buffer_Name : in String) return Error_T is
   begin
      return Load_Buffer (State => State, Buffer => Buffer, Size => Buffer'Last, Name => Buffer_Name);
   end Load_String;
   ...
   function Exec_File (State : State_t; File : String) return Error_t is
      Error_Code : Error_t;
   begin
      ...
      Error_Code := PCall(State, 0, -1, 0);
      return Error_Code;
   end Exec_File;

   function Exec_String (State : State_T; Str : String; Buffer_Name : in String) return Error_T is
      Error_Code : Error_t;
   begin
      Error_Code := Load_String (State, Str, Buffer_Name);
      if Error_Code /= Lua_Error_None then
         return Error_Code;
      end if;
      Error_Code := PCall(State, 0, -1, 0);
   ...
   function At_Panic (State : State_t; Panic_Function : User_Function_t) return User_Function_t is
   begin
      return C_Bindings.lua_atpanic (State, Panic_Function);
   end At_Panic;

   procedure At_Panic (State : State_t; Panic_Function : User_Function_t) is
   begin
      C_Bindings.lua_atpanic (State, Panic_Function);
   end At_Panic;

   -- default panic handler to properly raise an exception
   -- instead of calling exit(), which we *never* want to happen.
   function Catch_Panic ( L : State_t ) return Lua.Integer_t;
   pragma Convention(C, Catch_Panic );

   Lua_Panic_Exception : Exception;

   function Catch_Panic ( L : State_t ) return Lua.Integer_t
   is
      Error_Msg : constant String := To_String( L, -1 );
   begin
      raise Lua_Panic_Exception with Error_Msg;

      return 0;
   end Catch_Panic;

   function Open return State_t is
      State : State_t :=  C_Bindings.lual_newstate;
   begin
      -- we install the default handler
      At_Panic( State, Catch_Panic'access );

      -- and return our (safer) state
      return State;
   end Open;
   ...
   procedure Set_Top (State : State_t; Index : Integer) is
   begin
      C_Bindings.lua_settop (State, Integer_t (Index));
   end Set_Top;

   procedure Push_Value (State : State_t; Index : Integer) is
   begin
      C_Bindings.lua_pushvalue (State, Integer_t (Index));
   end Push_Value;

   procedure Remove (State : State_t; Index : Integer) is
   begin
      C_Bindings.lua_remove (State, Integer_t (Index));
   end Remove;

   procedure Insert (State : State_t; Index : Integer) is
   begin
      C_Bindings.lua_insert (State, Integer_t (Index));
   end Insert;

   procedure Replace (State : State_t; Index : Integer) is
   begin
      C_Bindings.lua_replace (State, Integer_t (Index));
   end Replace;

   function Check_Stack (State : State_t; Size : Integer) return Boolean is
   begin
   ...
   function Is_Number (State : State_t; Index : Integer) return Boolean is
   begin
      return C_Bindings.lua_isnumber (State, Integer_t (Index)) /= 0;
   end Is_Number;

   function Is_String (State : State_t; Index : Integer) return Boolean is
   begin
      return C_Bindings.lua_isstring (State, Integer_t (Index)) /= 0;
   end Is_String;

   function Is_User_Function (State : State_t; Index : Integer) return Boolean is
   begin
      return C_Bindings.lua_iscfunction (State, Integer_t (Index)) /= 0;
   end Is_User_Function;

   function Is_Userdata (State : State_t; Index : Integer) return Boolean is
   begin
      return C_Bindings.lua_isuserdata (State, Integer_t (Index)) /= 0;
   end Is_Userdata;

   function Is_Nil (State : State_t; Index : Integer) return Boolean is
   begin
      return C_Bindings.lua_type (State, Integer_t (Index)) = 0;
   end Is_Nil;

   function Is_None_Or_Nil (State : State_t; Index : Integer) return Boolean is
   begin
      return Is_None (State, Index) or Is_Nil (State, Index);
   end Is_None_Or_Nil;

   function Is_Table (State : State_t; Index : Integer) return Boolean is
   begin
      return Type_Of (State, Index) = T_Table;
   end Is_Table;

   function Is_Boolean (State : State_t; Index : Integer) return Boolean is
   begin
      return Type_Of (State, Index) = T_Boolean;
   end Is_Boolean;

   function Is_Function (State : State_t; Index : Integer) return Boolean is
   begin
      return Type_Of (State, Index) = T_Function;
   end Is_Function;

   function Is_Thread (State : State_t; Index : Integer) return Boolean is
   begin
      return Type_Of (State, Index) = T_Thread;
   end Is_Thread;

   function Is_None (State : State_t; Index : Integer) return Boolean is
   begin
      return Type_Of (State, Index) = T_None;
   end Is_None;

   function Is_Light_Userdata (State : State_t; Index : Integer) return Boolean is
   begin
      return Type_Of (State, Index) = T_Light_Userdata;
   end Is_Light_Userdata;

   function Type_Of (State : State_t; Index : Integer) return Type_t is
   ...
   function Type_Name (State : State_t; Index : Integer) return String is
   ...
   function To_Number (State : State_t; Index : Integer) return Number_t is
   begin
      return C_Bindings.lua_tonumberx (State, Integer_t (Index), null);
   end To_Number;

   function To_String (State : State_t; Index : Integer) return String is
   ...
   function To_Unbounded_String
     (State : State_t;
      Index : Integer)
      return  UB_Strings.Unbounded_String
   is
   begin
      return UB_Strings.To_Unbounded_String (To_String (State, Index));
   end To_Unbounded_String;

   function To_Boolean (State : State_t; Index : Integer) return Boolean is
   begin
      return C_Bindings.lua_toboolean (State, Integer_t (Index)) /= 0;
   end To_Boolean;

   function To_Integer (State : State_t; Index : Integer) return Integer_t is
   begin
      return C_Bindings.lua_tointegerx (State, Integer_t (Index), null);
   end To_Integer;

   function To_Thread (State : State_t; Index : Integer) return State_t is
   begin
      return C_Bindings.lua_tothread (State, Integer_t (Index));
   end To_Thread;

   function To_C_Function (State : State_t; Index : Integer) return User_Function_t is
   begin
      return C_Bindings.lua_tocfunction (State, Integer_t (Index));
   end To_C_Function;

   generic
     Op : C_Bindings.Lua_Cmp_Op;
   package Comparison is
      function Compare( State : State_T; Index1, Index2 : Integer ) return Boolean;
   end Comparison;

   package body Comparison is
      function Compare( State : State_T; Index1, Index2 : Integer ) return Boolean
      is
      begin
         return C_Bindings.Lua_Compare( State, Integer_t( Index1 ), Integer_t( Index2 ),  C_Bindings.Lua_Cmp_Op'Enum_Rep( Op )  ) /= 0;
      end;
   end Comparison;

   package Is_Equal_Pkg is new Comparison( C_Bindings.Lua_Op_Eq );
   function Is_Equal (State  : State_t; Index1 : Integer; Index2 : Integer) return   Boolean
        renames Is_Equal_Pkg.Compare;

   package Is_Less_Than_Pkg is new Comparison( C_Bindings.Lua_Op_Lt );
   function Is_Less_Than (State  : State_t; Index1 : Integer; Index2 : Integer) return   Boolean
        renames Is_Less_Than_Pkg.Compare;

   package Is_Less_Or_Equal_Pkg is new Comparison( C_Bindings.Lua_Op_Le );
   function Is_Less_Or_Equal (State  : State_t; Index1 : Integer; Index2 : Integer) return   Boolean
        renames Is_Less_Or_Equal_Pkg.Compare;
   ...
   function Object_Length (State : State_t; Index : Integer) return Integer_t is
   begin
      return C_Bindings.lua_len (State, Integer_t (Index));
   end Object_Length;

   function Object_Raw_Length (State : State_t; Index : Integer) return Integer_t is
   begin
      return C_Bindings.lua_rawlen (State, Integer_t (Index));
   end Object_Raw_Length;
   ...
   procedure Push_Number (State : State_t; N : Number_t) is
   begin
      C_Bindings.lua_pushnumber (State, N);
   end Push_Number;

   procedure Push_Integer (State : State_t; I : Integer_t) is
   begin
      C_Bindings.lua_pushinteger (State, I);
   end Push_Integer;

   procedure Push_Boolean (State : State_t; B : Boolean) is
   begin
      if B then
   ...
   procedure Push_String (State : State_t; Str : ICS.chars_ptr) is
   begin
      C_Bindings.lua_pushstring (State, Str);
   end Push_String;

   procedure Push_String (State : State_t; Str : String) is
   begin
      if Str'Length > 0 then
         C_Bindings.lua_pushlstring
           (State   => State,
   ...
   procedure Push_String (State : State_t; Str : UB_Strings.Unbounded_String) is
      C_Buffer : aliased IC.char_array := IC.To_C (UB_Strings.To_String (Str));
   begin
      C_Bindings.lua_pushstring
        (State => State,
         Str   => ICS.To_Chars_Ptr (C_Buffer'Unchecked_Access));
   end Push_String;

   procedure Push_String (State : State_t; Address : System.Address; Size : Positive) is
   begin
      C_Bindings.lua_pushlstring (State => State, Address => Address, Size => IC.size_t (Size));
   end Push_String;

   procedure Push_User_Closure (State : State_t; Func : User_Function_t; Num_Params : Integer) is
   begin
      C_Bindings.lua_pushcclosure (State, Func, Integer_t (Num_Params));
   end Push_User_Closure;

   procedure Push_User_Function (State : State_t; Func : User_Function_t) is
   begin
      C_Bindings.lua_pushcclosure (State, Func, 0);
   end Push_User_Function;


   procedure Push_Global_Table (State : State_t) is
   begin
      Raw_Get_Index( State, Registry_Index, Registry_Index_Globals );
   end Push_Global_Table;

   procedure Concat (State : State_t; N : Natural) is
   begin
   ...
   procedure Get_Table (State : State_t; Index : Integer) is
   begin
      C_Bindings.lua_gettable (State, Integer_t (Index));
   end Get_Table;

   function Get_Metatable (State : State_t; Index : Integer) return Error_t is
   begin
      return Error_t'Val (C_Bindings.lua_getmetatable (State, Integer_t (Index)));
   end Get_Metatable;

   procedure Raw_Get (State : State_t; Index : Integer) is
   begin
      C_Bindings.lua_rawget (State, Integer_t (Index));
   end Raw_Get;

   procedure Raw_Get_Index (State : State_t; Index : Integer; Element : Integer) is
   begin
      C_Bindings.lua_rawgeti (State, Integer_t (Index), Integer_t (Element));
   end Raw_Get_Index;

   procedure Get_Field (State : State_t; Index : Integer; Key : ICS.chars_ptr) is
   begin
      C_Bindings.lua_getfield (State, Integer_t (Index), Key);
   end Get_Field;

   procedure Get_Field (State : State_t; Index : Integer; Key : String) is
   ...
   procedure Get_Field (State : State_t; Index : Integer; Key : UB_Strings.Unbounded_String) is
   ...
   procedure Get_Global (State : State_t; Key : String) is
      C_Buffer : aliased IC.char_array := IC.To_C (Key);
   begin
      C_Bindings.lua_getglobal
        (State => State,
         Key   => ICS.To_Chars_Ptr (C_Buffer'Unchecked_Access));
   end Get_Global;

   procedure Get_Global (State : State_t; Key : UB_Strings.Unbounded_String) is
      C_Buffer : aliased IC.char_array := IC.To_C (UB_Strings.To_String (Key));
   begin
      C_Bindings.lua_getglobal
        (State => State,
   ...
   procedure Set_Table (State : State_t; Index : Integer) is
   begin
      C_Bindings.lua_settable (State, Integer_t (Index));
   end Set_Table;

   function Set_Metatable (State : State_t; Index : Integer) return Error_t is
   begin
      return Error_t'Val (C_Bindings.lua_setmetatable (State, Integer_t (Index)));
   end Set_Metatable;

   procedure Raw_Set (State : State_t; Index : Integer) is
   begin
   ...
   procedure Raw_Set_Index (State : State_t; Index : Integer; Element : Integer) is
   begin
      C_Bindings.lua_rawseti (State, Integer_t (Index), Integer_t (Element));
   end Raw_Set_Index;

   procedure Set_Field (State : State_t; Index : Integer; Key : ICS.chars_ptr) is
   begin
      C_Bindings.lua_setfield (State => State, Index => Integer_t (Index), Key => Key);
   end Set_Field;

   procedure Set_Field (State : State_t; Index : Integer; Key : String) is
      C_Buffer : aliased IC.char_array := IC.To_C (Key);
   begin
   ...
   procedure Set_Field (State : State_t; Index : Integer; Key : UB_Strings.Unbounded_String) is
      C_Buffer : aliased IC.char_array := IC.To_C (UB_Strings.To_String (Key));
   begin
      C_Bindings.lua_setfield
        (State => State,
   ...
   procedure Set_Global (State : State_t; Key : String) is
      C_Buffer : aliased IC.char_array := IC.To_C (Key);
   begin
      C_Bindings.lua_setglobal
        (State => State,
         Var   => ICS.To_Chars_Ptr (C_Buffer'Unchecked_Access));
   end Set_Global;

   procedure Set_Global (State : State_t; Key : UB_Strings.Unbounded_String) is
      C_Buffer : aliased IC.char_array := IC.To_C (UB_Strings.To_String (Key));
   begin
      C_Bindings.lua_setglobal
        (State => State,
   ...
   function Ret_Error (Error_Code : Error_t; Message : String) return Error_Message_t is
   ...
   function Resume (State : State_t; Num_Arguments : Integer) return Error_Message_t is
      Error : Error_t;
      NDX   : constant Integer_t := C_Bindings.lua_gettop (State) - Integer_t (Num_Arguments);
   begin
      Push_String (State, "_traceback");
      Push_Global_Table( State );
      C_Bindings.lua_rawget (State, -2  ); -- -2 is index of global table
   ...
   exception
      when err : others =>
         return Ret_Error
                  (Lua_Exception,
                   "exception while doing lua.traced_call:" &
                   CR &
                   LF &
   ...
   is
   begin
      C_Bindings.lua_pushcclosure (State, Func_Ptr, Nb_Args);
      Set_Global (State, Func_Name);
   end Register;

   function UpValue_Index (I : Integer_t) return Integer is
   begin
      return Integer (Registry_Index - Integer( I ) );
   end UpValue_Index;

   procedure Call (State : State_t; Num_Arguments : Integer; Num_Results : Integer) is
   begin
      C_Bindings.lua_callk
        (State         => State,
   ...
   procedure Pop (State : State_t; Count : Integer) is
   begin
      Set_Top (State, -(Count) - 1);
   end Pop;

   function Next (State : State_t; Index : Integer) return Integer is
   begin
   ...
   procedure Unreference (State : State_t; Ref : Object_Ref_t) is
   begin
      Unreference (State, Registry_Index, Ref);
   end Unreference;

   procedure Dereference (State : State_t; Ref : Object_Ref_t) is
   begin
