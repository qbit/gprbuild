/* ********************************************************************************************
    ...
    FILE NAME :             FCVARS.C    $Revision: 1.1 $
    Module Description:     Global variable allocation
...
#include "fccommon.h"
#undef FC_EXTERN             /* EXTERN was defined as extern for definition */
#define FC_EXTERN            /* now we want no def so vars will be delcared */
#undef FCVARS_H              
#include "fcvars.h"
