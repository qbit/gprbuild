/*********************************************************************************************
    ...
    FILE NAME :             FCVARS.H    $Revision: 1.1 $
    Module Description:     Definitions of global variables used by the FCAPI
...
FC_EXTERN HostAdapterType HostAdapters[MAX_ADAPTERS];    
