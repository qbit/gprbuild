/*********************************************************************************************
    ...
    FILE NAME :             FC_Q_MON.H   $Revision: 1.1 $
 ...
 *
 * Refer to fc_q_typ.h for the definition of the resource management structures.
 * This header file provides function prototypes for fc_q_mon.c
 *
 * */
...
#define q_full(x)   (x->TransferMgr.free_head == FC_NULL)
#define free_count(x)  (x->TransferMgr.free_count)
